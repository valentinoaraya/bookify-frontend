...
export const CompanyIcon: React.FC<Props> = ({ width, height, fill }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill} className="bi bi-building-fill" viewBox="0 0 16 16">
...
export const SearchIcon: React.FC<Props> = ({ width, height, fill }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill} className="bi bi-search" viewBox="0 0 16 16">
            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0" />
        </svg>
    );
}

export const PlusIcon: React.FC<Props> = ({ width, height, fill }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill} className="bi bi-plus-circle-fill" viewBox="0 0 16 16">
...
export const NewWindowIcon: React.FC<Props> = ({ width, height, fill }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill} className="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
...
export const CalendarCheckIcon: React.FC<Props> = ({ width, height, fill }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill} className="bi bi-calendar-check" viewBox="0 0 16 16">
...
export const UsersIcon: React.FC<Props> = ({ width, height, fill }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill} className="bi bi-people" viewBox="0 0 16 16">
...
export const ArrowReturnIcon: React.FC<Props> = ({ width, height, fill }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill} className="bi bi-arrow-return-left" viewBox="0 0 16 16">
            <path fillRule="evenodd" d="M14.5 1.5a.5.5 0 0 1 .5.5v4.8a2.5 2.5 0 0 1-2.5 2.5H2.707l3.347 3.346a.5.5 0 0 1-.708.708l-4.2-4.2a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 8.3H12.5A1.5 1.5 0 0 0 14 6.8V2a.5.5 0 0 1 .5-.5" />
        </svg>
    )
}

export const RocketIcon: React.FC<Props> = ({ width, height, fill }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fill} className="bi bi-rocket-takeoff-fill icon-settings" viewBox="0 0 16 16">
...
export const MapPinIcon: React.FC<Props> = ({ width, height, fill }) => {
    return (
